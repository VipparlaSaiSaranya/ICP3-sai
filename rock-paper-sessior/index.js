...
let playerInitalScore = 0;
let computerInitalScore = 0;
...
// get buttons with id 
let rockButton = document.getElementById("RockClickButton");
let paperButton = document.getElementById("paperClickButton");
let sessiorButton = document.getElementById("sessiorClickButton");
...
function updateScore(){
    playerScore.textContent = playerInitalScore;
    computerScore.textContent = computerInitalScore;
}
updateScore();
...
function displayText(){
    ...
    if(computerChoiceText==="Rock"){
        computerChoice.style.color="#FF33CE";
    }else if (computerChoiceText==="Paper"){
        computerChoice.style.color="#F8F004";
    }
    else if(computerChoiceText==="Scissors"){
        computerChoice.style.color = "#0499F8";
    } 
